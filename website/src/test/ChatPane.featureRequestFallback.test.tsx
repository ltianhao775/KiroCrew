...
const requestRow: Msg = { role: 'user', content: 'I’d like to request a feature!', ts: '2026-09-01T00:00:00Z' }
...
function mount(messages: Msg[], featureRequestSlots: string[]) {
...
describe('ChatPane — a feature request refused for a usage limit offers the issue form (#13342)', () => {
  it('renders the form link with its explanation on the usage-limit row of the pill\'s slot', () => {
    mount([requestRow, limitRow], [SLOT])
  ...
  it('renders today\'s row for the same error in a slot the pill did not create', () => {
    mount([{ role: 'user', content: 'refactor the parser', ts: '2026-09-01T00:00:00Z' }, limitRow], [])
